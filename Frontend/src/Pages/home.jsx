                ...
                <div className="row">
                    <div className="col-sm-12 col-md-4 mb-4">
                        <div className="card shadow-sm card-img-top">
                            <img src={pizza}  alt="Pizza" style={{ height: '200px', objectFit: 'cover' }} />
                            <div className="card-body text-center">
                                ...
                                <Link to="/pizza" className="btn btn-primary">View</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-4 mb-4">
                    <div className="card shadow-sm card-img-top">
                            <img src={paneer}  alt="Paneer" style={{ height: '200px', objectFit: 'cover' }} />
                            <div className="card-body text-center">
                                <h5 className="card-title">Paneer</h5>
                                <p className="card-text">Mouthwatering paneer dishes like paneer chingari, paneer lazeez.</p>
                                <Link to="/paneer" className="btn btn-primary">View</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-4 mb-4">
                    <div className="card shadow-sm card-img-top">
                            <img src={biryani} alt="Biryani" style={{ height: '200px', objectFit: 'cover' }} />
                            <div className="card-body text-center">
                                <h5 className="card-title">Biryani</h5>
                                <p className="card-text">Hyderabadi veg and non-veg biryanis are available. Explore more.</p>
